          ...
          inputCollapsed
            ...
            : h(React.Fragment, null,
                ...
                h('textarea', {
                  ...
                  placeholder: resultView ? '粘贴要追加的段落或新资料（将合并进当前知识图，跨段关系自动建立）…' : '粘贴资料正文，或只上传包含文字、图示、表格的图片…',
                ...
                h('div', { className: 'kg-actions' },
                  !resultView && imageInputs.length > 0 ? h('div', { className: 'kg-image-list', 'aria-label': '已选择图片' },
                   ...
                   !resultView ? h(React.Fragment, null,
                     ...
                     h('button', { type: 'button', className: 'kg-secondary kg-image-upload-btn', disabled: imagePreparing || imageInputs.length >= MAX_IMAGE_INPUTS, onClick: () => imageInputRef.current && imageInputRef.current.click() }, imagePreparing ? '⏳ 正在读取…' : '🖼 上传图片'),
                   ) : null,
