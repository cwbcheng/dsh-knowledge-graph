...
.kg-source-image { flex: 0 0 150px; border: 1px solid var(--kg-border); border-radius: 10px; padding: 6px; background: var(--kg-panel); color: var(--kg-text); cursor: pointer; text-align: left; }
            ...
            : h(React.Fragment, null,
                ...
                h('div', { className: 'kg-actions' },
                  ...
                  text.trim().length > 0 || imageInputs.length > 0
                    ? h('button', { type: 'button', className: 'kg-secondary', onClick: () => { setText(''); setTitle(''); clearImageInputs() } }, '清空')
                    : null,
                  resultView
                    ? h('button', {
                        type: 'button', className: 'kg-primary',
              ...
              return h('section', { className: 'kg-card kg-result', 'aria-label': '原文 ⇄ 知识图结果' },
                ...
                h('div', {
                  ...
                  h('div', { className: 'kg-original', 'aria-label': '原文段落', style: { maxHeight: resultHeight + 'px' } },
                    visualImages.length > 0 ? h(React.Fragment, null,
