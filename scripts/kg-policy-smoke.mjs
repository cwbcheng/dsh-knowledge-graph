...
assert(host.includes('function consumptionEvidenceSupportsPartHost') && host.includes('function consumptionSupportedEvidenceIdsHost') && host.includes('consumptionSupportedEvidenceIdsHost(text, ids, evidenceById)'), 'answer admission does not reject valid-but-irrelevant evidence IDs per answer clause')
